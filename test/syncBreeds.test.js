...
describe('#breedDetails', () => {
  it('returns breed details for the Bombay breed', () => {
    ...
    assert.equal(expectedDescBombay, bombay);
  });
  ...
  it('returns undefined when no description is provided for the breed name', () => {
    assert.isUndefined(breedDetails('shorthair domestic'));
  })
});